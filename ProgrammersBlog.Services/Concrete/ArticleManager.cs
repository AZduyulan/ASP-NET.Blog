    ...
    public class ArticleManager : IArticleService
    {
        ...
        public async Task<IResult> Delete(int articleId, string modifiedByName)
        {
            ...
            if (result)
            {
                ...
                await _unitOfWork.SaveAsync();
                return new Result(ResultStatus.Success, $"{article.Title} başarıyla silindi");
        ...
        public async Task<IDataResult<ArticleListDto>> GetAll()
        {
            ...
            return new DataResult<ArticleListDto>(ResultStatus.Error, "Hiç makale yok", null);
        }
        ...
        public async Task<IDataResult<ArticleListDto>> GetAllByCategory(int categoryId)
        {
            ...
            return new DataResult<ArticleListDto>(ResultStatus.Error, "Böyle bir kategori yok", null);
        ...
        public async Task<IResult> HardDelete(int articleId)
        {
            ...
            if (result)
            {
                ...
                await _unitOfWork.SaveAsync();
                return new Result(ResultStatus.Success, $"{article.Title} başarıyla veri tabanından silindi");
        ...
        public async Task<IResult> Update(ArticleUpdateDto articleUpdateDto, string modifiedByName)
        {
            ...
            await _unitOfWork.Articles.UpdateAsync(article);
            await _unitOfWork.SaveAsync();
            return new Result(ResultStatus.Success, $"{articleUpdateDto.Title} adlı makale başarıyla güncelendi");
        }
    }
}
